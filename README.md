...
<div class="card" id="etalasePage" style="display:none;">
  ...
  <div class="product">
    <h3>Produk 1</h3>
    <img src="Product 1.jpeg" alt="Produk 1" style="width:100%;border-radius:10px;margin-bottom:10px;" />
  ...
  <div class="product">
    <h3>Produk 2</h3>
    <img src="Product 2.jpeg" alt="Produk 2" style="width:100%;border-radius:10px;margin-bottom:10px;" />
